...
<b>Note:</b> If you are not familiar with Netrek vocabulary terms such
as ++, LPS, Pop, DI, and Ogg, see the <a href="#vocabulary">short
vocabulary section at the end</a>, or the <a
href="../glossary.php">full netrek glossary.</a>
<br><br><p>
Topics in this guide include:
<ul>
<li><a href="#cluehints">Getting Clued</a>
<li><a href="#dogfighting">Dogfighting</a>
<li><a href="#escorting">Escorting</a>
<li><a href="#planetdefence">Planet Defence</a>
<li><a href="#planettaking">Planet Taking</a>
<li><a href="#ogging">Ogging</a>
<li><a href="#baseogging">Ogging a Starbase</a>
<li><a href="#basedefense">Defending a Starbase</a>
<li><a href="#bombing">Bombing</a>
<li><a href="#basing">Playing a Starbase</a>
<li><a href="#general">General Questions/Notes</a>
<li><a href="#summary">Conclusion</a>
<li><a href="#vocabulary">Appendix: Vocabulary</a>
</ul>

<br><p>
<h2 id="cluehints">The way to become a "clued" player</h2>
<br><p>First, there are no shortcuts. You have to play a lot and get experience
but here are a few hints that will help you on the way.
<ul>
